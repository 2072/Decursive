...
Dcr.LOC.OPT_TIE_LIVELIST_DESC = "The live-list fills itself from bottom to top";
...
Dcr.LOC.OPT_MFSETTINGS_DESC = "Set the micro units frame window to sweets your needs";
...
Dcr.LOC.OPT_CURINGOPTIONS = "Curring options";
Dcr.LOC.OPT_CURINGOPTIONS_DESC = "Set different aspects of the curring process";
...
Dcr.LOC.OPT_DEBUFFFILTER_DESC = "Select debuffs to filter out by name and class";
