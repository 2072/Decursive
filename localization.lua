...
LOC.IGNORE_STEALTH  = "Ignore Stealthed Units";
...
LOC.OPT_PRINT_CUSTOM_DESC = "Decursive's messages will be printed in a custome chat frame";
...
LOC.OPT_RANDOMORDER_DESC = "Units will be displayed and cured randomly (not recomended)";
LOC.OPT_CUREPETS_DESC = "Pets will be managed and cured";
LOC.OPT_IGNORESTEALTHED_DESC = "Stealthed units will be ignored";
...
LOC.OPT_POISONCHECK_DESC = "If checked you'll be able to see and cure poisonned units";
...
LOC.SUCCESSCAST = "%s |cFF00AA00succeeded on|r %s";
...
LOC.MACROKEYNOTMAPPED = "Decursive macro is not mapped to a key, you can map a key through the option menu. (do not miss this wonderful feauture)";
