...
L:RegisterTranslations("ruRU", function() return {
    ...
    -- $t is target name
    [LOC.SPELL_FOUND]      = "Найдено %s заклинание!",
    ...
    [LOC.OPT_MFREFRESHRATE_DESC] = "Время между каждым запрос обновления (1 or several micro-unit-frames can be refreshed at once)",
