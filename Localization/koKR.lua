...
--]]
  ...
  [LOC.OPT_CREATE_VIRTUAL_DEBUFF] = "가상 테스트 디버프 생성",
...
-- NEW LOCALS FOR 2.0
	...
	[LOC.OPT_SHOWMFS] = "작은 유닛 프레임(MUF) 표시",
	[LOC.OPT_SHOWMFS_DESC] = "클릭으로 해제하려면 반드시 활성화 되어야 합니다.",

  [LOC.OPT_AUTOHIDEMFS]	    = "자동숨김",
  [LOC.OPT_AUTOHIDEMFS_DESC]    = "선택하면 언제 MUF창을 숨겨둘지 설정합니다.",

  [LOC.OPT_HIDEMFS_SOLO]	    = "솔로",
  [LOC.OPT_HIDEMFS_SOLO_DESC]	    = "MUF창을 파티나 공격대에 속해있지 않을 때 숨겨둡니다.",

  [LOC.OPT_HIDEMFS_GROUP]	    = "솔로/파티",
  [LOC.OPT_HIDEMFS_GROUP_DESC]    = "MUF창을 공격대에 속해있지 않을 때 숨겨둡니다.",

  [LOC.OPT_HIDEMFS_NEVER]	    = "사용안함",
  [LOC.OPT_HIDEMFS_NEVER_DESC]    = "MUF창의 자동숨김을 사용하지 않습니다.",

  [LOC.OPT_ADDDEBUFFFHIST]		= "최근의 디버프 추가",
  [LOC.OPT_ADDDEBUFFFHIST_DESC]	= "예전에 사용된 디버프를 추가합니다.",
	...
	[LOC.COLORCHRONOS]		= "크로노미터",
	[LOC.COLORCHRONOS_DESC]		= "크로노미터의 색상을 설정합니다.",

	[LOC.OPT_SHOWBORDER] = "직업 색상 테두리 표시",
	[LOC.OPT_SHOWBORDER_DESC] = "MUF에 유닛의 직업에 따른 색상을 테두리로 표시합니다.",
  [LOC.OPT_SHOWCHRONO] = "크로노미터 표시",
  [LOC.OPT_SHOWCHRONO_DESC] = "유닛이 주문에 걸린 이후 경과된 초의 숫자를 표시합니다.",
	...
	[LOC.OPT_CHARMEDCHECK_DESC] = "체크 시 지배에 걸린 대상을 표시하고 변이합니다.",
	...
	[LOC.OPT_REMOVETHISDEBUFF_DESC] = "제외 목록에서 '%s' 제거",
	...
	[LOC.OPT_TIECENTERANDBORDER_OPT] = "체크 시 테두리의 투명도가 가운데 투명도의 절반이 됩니다.",
	...
	[LOC.OPT_XSPACING_DESC] = "MUF 사이의 수평 간격을 설정합니다.",
	[LOC.OPT_YSPACING] = "수직 간격",
	[LOC.OPT_YSPACING_DESC] = "MUF 사이의 수직 간격을 설정합니다.",

  [LOC.OPT_SHOWMINIMAPICON] = "미니맵 아이콘",
  [LOC.OPT_SHOWMINIMAPICON_DESC] = "미니맵 아이콘을 표시합니다.",
	...
	[LOC.FAILEDCAST]	= "|cFF22FFFF%s %s|r|1으로;로; %s |cFFAA0000치료 실패|r\n|cFF00AAAA%s|r",

	[LOC.HANDLEHELP] 	= "작은 유닛 프레임(MUF) 모두 이동",
