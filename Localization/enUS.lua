...
L["OPT_ENABLE_BLEED_EFFECTS_DETECTION_DESC"] = "Enable Decursive to discover new bleed effects when their description contains the identifier indicated in the 'Bleed effect identifier' field"
