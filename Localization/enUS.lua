...
L["OPT_BLEED_EFFECT_IDENTIFIER_DESC"] = "Should match the term found in the description of the debuff causing the target to bleed and that can be used to identify such effect.\nClear the field to reset to the default."
